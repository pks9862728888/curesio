    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('days_in_hospital', models.IntegerField(verbose_name='Days in hospital')),
                ('days_in_destination', models.IntegerField(verbose_name='Days in destination')),
                ('duration_minutes', models.IntegerField(verbose_name='Duration in minutes')),
