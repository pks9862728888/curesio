# Generated by Django 2.2.9 on 2020-01-11 08:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secondary_language', models.CharField(choices=[('EN', 'English'), ('BN', 'Bengali'), ('HI', 'Hindi')], default='EN', max_length=3, verbose_name='Secondary language')),
                ('tertiary_language', models.CharField(choices=[('EN', 'English'), ('BN', 'Bengali'), ('HI', 'Hindi')], default='EN', max_length=3, verbose_name='Tertiary language')),
            ],
